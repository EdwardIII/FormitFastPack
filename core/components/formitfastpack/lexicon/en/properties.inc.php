...
$_lang['ffp_field_outer_type_desc'] = 'The outer wrapper type. Used to decide which subset of the outer_tpl chunk to use. ';
...
$_lang['ffp_field_delimiter_template_desc'] = 'You can change the default delimiter that is used to split the fieldTypesTpl based on type.';
